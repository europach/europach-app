...
export const TurkeyEvents = [
...

  {
    ...
    linksWith: ['the_old_turkish_criminal', 'eu_access_and_harmonization'],
    baseStory: baseStory,
  },

  {
    ...
    linksWith: ['the_old_turkish_civil', 'the_new_turkish_civil'],
    baseStory: baseStory,
  },

  {
    ...
    linksWith: ['the_old_turkish_civil'],
    baseStory: baseStory,
  },

  {
    ...
    endDate: '2001/11/02',
    logics: [LOGICS.publicHealth, LOGICS.securitisation],
    linksWith: ['swiss_civil_code', 'eu_access_and_harmonization', 'the_old_turkish_civil'],
    baseStory: baseStory,
  },
...

  {
    ...
    linksWith: ['zannerdelli_code', '1999_eu_access_and_harmonization', 'the_new_turkish_criminal', 'the_law_on_the', 'case_ümit_ulukaya', 'sevgi_zindan_ulukaya'],
    baseStory: baseStory,
  },

  {
    ...
    endDate: '2015/11/',
    logics: [LOGICS.humanitarianism, LOGICS.publicHealth, LOGICS.securitisation],
    linksWith: ['case_ümit_ulukaya', 'regulation_on_marriage_procedures', 'positive_living_association'],
    baseStory: baseStory,
  },

  {
    ...
    endDate: '',
    logics: [LOGICS.publicHealth, LOGICS.securitisation],
    linksWith: ['regulation_on_marriage_procedures', 'reporting_cases_of_hivaids', 'case_ümit_ulukaya', 'sevgi_ulukaya'],
    baseStory: baseStory,
  },
...

  {
    ...
    endDate: '2007/05',
    logics: [LOGICS.publicHealth, LOGICS.securitisation],
    linksWith: ['red_crescent_kızılay', 'regulation_on_marriage_procedures', 'eu-access_and_harmonization'],
    baseStory: baseStory,
  },

  {
    ...
    endDate: '2006',
    logics: [LOGICS.publicHealth, LOGICS.securitisation],
    linksWith: ['health_certificate_from_a', 'public_health_law_umumi', 'Sevgi_Ulukaya', 'new_turkish_civil_code', 'case_against_health_authorities'],
    baseStory: baseStory,
  },

  {
    ...
    endDate: '2006',
    logics: [LOGICS.publicHealth, LOGICS.securitisation],
    linksWith: ['regulation_on_marriage_procedures', 'case_ümit_ulukaya', 'Sevgi_Ulukaya', 'new_turkish_civil_code'],
    baseStory: baseStory,
  },
...

  {
    ...
    linksWith: ['case_ümit_ulukaya', 'sevgi_ulukaya', 'the_report_of_forensic'],
    baseStory: baseStory,
  },

  {
    ...
    startDate: '1997',
    endDate: '2006',
    logics: [LOGICS.decriminalization, LOGICS.humanRights, LOGICS.humanitarianism, LOGICS.publicHealth, LOGICS.securitisation],
    linksWith: ['the_old_turkish_criminal', 'the_new_turkish_criminal', 'turkish_armed_forces_health', 'Sevgi Ulukaya', 'report_of_forensic_medicine', 'the_law_on_the'],
    baseStory: baseStory,
  },

  {
    ...
    startDate: '1999/11',
    endDate: '2006/05',
    logics: [LOGICS.decriminalization, LOGICS.securitisation],
    linksWith: ['case_ümit_ulukaya'],
    baseStory: baseStory,
  },
...

  {
    ...
    endDate: '2006/05',
    logics: [LOGICS.humanRights, LOGICS.humanitarianism, LOGICS.securitisation],
    linksWith: ['1999_european_council_helsinki'],
    baseStory: baseStory,
  },
...

  {
    ...
    endDate: '2015/10',
    logics: [LOGICS.decriminalisation, LOGICS.securitisation],
    linksWith: ['regulation_on_marriage_procedures', 'case_ümit_ulukaya', 'sevgi_zindan_ulukaya', 'law_of_misdemeanors_kabahatlar'],
    baseStory: baseStory,
  },
