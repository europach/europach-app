...
export const GermanyEvents = [
  {
    ...
    linksWith: [
      '1973_coe_european_prison',
      '1982_un_principles_of',
      '1990_un_basic_principles',
      '1989_reform_of_german',
      '1993_who_guidelines_on',
    ],
    baseStory: baseStory,
  },

  {
    ...
    logics: [LOGICS.humanRights],
    linksWith: [
      '1955_un_standard_minimum',
      '1987_coe_update_of',
      '1989_coe_european_convention',
    ],
    baseStory: baseStory,
  },

  {
    ...
    sources: [
      {
        type: 'text',
        content:
          'Frommel, Monika 2008. 40 Jahre Strafrechtsreform. Neue Kriminalpolitik 20(4):133-139.',
      },
      {
        type: 'text',
        content:
          'Michels, Ingo Ilja 1989. Thesen zur Situation von Menschen mit HIV und Menschen mit AIDS im Strafvollzug und in der Psychiatrie. In Deutsche AIDS-Hilde (eds.), Chancen und Risiken aktueller Präventions- und Behandlungsansätze am Faktor AIDS bei Drogengebrauch und Abhängigkeit. Berlin. ',
      },
      {
        type: 'text',
        content:
          'Stöver, Heino 2015. Gesundheit und Gesundheitsversorgung Gefangener. In: B. Badura et al. (eds.), Fehlzeiten-Report 2015. Berlin, pp. 259-269.',
      },
      {
        type: 'text',
        content:
          'Deutsche AIDS-Hilfe 1999. Fachtagung "Spritzenvergabe im Justizvollzug", Dokumentation. Berlin, pp.12-13.',
      },
    ],
    startDate: '1977',
    endDate: '',
    ...
    linksWith: [
      '1992_berlin_parliamentary_request',
      '1994_berlin_parliamentary_debate',
    ],
    baseStory: baseStory,
  },

  {
    ...
    linksWith: [
      '1955_un_standard_minimum',
      '1987_who_statement_from',
      '1988_prisoners_complaint_for',
      '1989_coe_european_convention',
      '1989_reform_of_german',
      '1990_un_basic_principles',
      '1993_who_guidelines_on',
...

  {
    ...
    sources: [
      {
        type: 'text',
        content:
          'Stöver, Heino 2014. Akzeptierende Gesundheitsförderung: Musterbeispiel HIV/AIDS-Prävention? In: Schmidt, Bettina (ed.), Akzeptierende Gesundheitsförderung: Unterstützung zwischen Einmischung und Vernachlässigung. Weinheim: Beltz Juventa, pp.244-228.',
      },
      {
        type: 'text',
        content:
          'Paas, Susanne 1987. AIDS-Bekämpfung mit Spritzen-Automaten. Die Tageszeitung, 29.8.1987. Berlin.',
      },
      {
        type: 'text',
        content:
          'Interviews conducted within the framework of EUROPACH project.',
      },
    ],
    startDate: '1984',
    endDate: '',
    ...
    linksWith: [
      '1988_public_throw_in',
      '1988_prisoners_complaint_for',
      '1989_jes_is_founded',
      '1990_1st_international_harm',
      '1992_amendment_of_narcotics',
      '6_jun_1996_berlin',
    ],
    baseStory: baseStory,
  },
    ...
    sources: [
      {
        type: 'text',
        content:
          'Gähner, Michael 1985. AIDS hinter Gittern. Problematik im Rechtsausschuss. Der Lichtblick 18(October):17-18.',
      },
      {
        type: 'text',
        content:
          'Gähner, Michael 1989. AIDS und Strafvollzug. Der Lichtblick 21(March, April):12-13.',
      },
    ],
    ...
    sources: [
      {
        type: 'text',
        content:
          'Elger, Benice S. 2008. Gesundheitsfürsorge für Strafgefangene im Kanton Genf. In: Hillenkamp, Thomas/ Tag, Brigitte (eds.), Intramurale Medizin im internationalen Vergleich: Gesundheitsfürsorge zwischen Heilauftrag und Strafvollzug im Schweizerischen und internationalen Diskurs. Berlin: Springer, pp. 49-71.',
      },
      {
        type: 'text',
        content:
          'Jürgens, Ralf 2006. HIV/AIDS and HCV in prisons: A select annotated bibliography (part 1). International Journal of Prisoner Health 2(1):21-34.',
      },
    ],
    startDate: '1987',
    endDate: '',
    ...
    sources: [
      {
        type: 'text',
        content:
          'Deutscher Bundestag 1990. Endbericht der Enquete-Kommission "Gefahren von AIDS und wirksame Wege zu ihrer Eindämmung". 11. Wahlperiode. Drucksache 11/7200.',
      },
      {
        type: 'text',
        content:
          'Stöver, Heino/Knorr, Bärbel 2014. Spritzenvergabe in (deutschen) Haftanstalten. In: Stöver, Heino/Knorr, Bärbel (eds.), HIV und Hepatitis-Prävention in Haft - keine Angst vor Spritzen! Oldenburg: BIS-Verlag, pp. 31-46.',
      },
      {
        type: 'text',
        content:
          'Debus, B. 1987. "Letztlich ratlos" - Interview mit Eberhard Hoffmann, der seit 15 Jahren die Justizvollzuganstalt Oslebshausen leitet. Die Tageszeitung, 30.5.1987, Berlin.',
      },
    ],
    startDate: '1990',
    endDate: '',
    ...
    sources: [
      {
        type: 'text',
        content:
          'Deutsche AIDS-Hilfe 1989. Chancen und Risiken aktueller Präventions- und Behandlungsansätze am Faktor AIDS bei Drogengebrauch und Abhängigkeit. Expertenhearing der Deutschen AIDS-Hilfe e.V. Berlin: DAH, pp. 212–214.',
      },
    ],
    startDate: '1988',
    endDate: '',
    ...
    sources: [
      {
        type: 'text',
        content:
          'Deutscher Bundestag 1988. Entwurf eines Gesetzes zur Strukturreform im Gesundheitswesen, 3.5.1988. Drucksache 11/2237.',
      },
      {
        type: 'text',
        content:
          'Bundesgesetzblatt 1988. Gesetz zur Strukturreform im Gesundheitswesen, Nr. 62, 29.12.1988. URL https://www.bgbl.de/xaver/bgbl/start.xav?startbk=Bundesanzeiger_BGBl&jumpTo=bgbl188s2477.pdf#__bgbl__%2F%2F*%5B%40attr_id%3D%27bgbl188s2477.pdf%27%5D__1558443233764',
      },
    ],
    startDate: '1989',
    endDate: '',
...

  {
    ...
    linksWith: [
      '1984_first_syringe_exchanges',
      '1991_akzept_ev_is',
      '1995_action_week_syringes',
      '1996_lower_saxony_and',
    ],
    baseStory: baseStory,
  },
...

  {
    ...
    sources: [
      {
        type: 'text',
        content:
          '62. Sitzung des Strafvollzugsausschusses der Länder vom 15. Bis zum 18. Oktober 1985 TOP 4 – AIDS im Strafvollzug. Archival resource: Landesarchiv NRW, NW 0765-22 3/1985-1/1988, Blätter 203-206',
      },
      {
        type: 'text',
        content:
          'Michels, Ingo 1990. Münchner AIDS-Tage, 19. bis 21.01.1990 AG Strafvollzug. Documentation of the conference.',
      },
      {
        type: 'text',
        content:
    ...
    logics: [
      ...
      LOGICS.mutualHelp,
      LOGICS.dissent,
      LOGICS.collaborativeGovernance,
    ],
    linksWith: [
      '1996_lower_saxony_and',
      '6_jun_1996_berlin',
    ...
    sources: [
      {
        type: 'text',
        content:
          'Aretz, Bernd 2015. „Als Gegengewicht zur Repression weiterhin gebraucht“. Magazin.hiv, 28.4.2015. URL: https://magazin.hiv/2015/04/28/als-gegengewicht-zur-repression-weiterhin-gebraucht/',
      },
      {
        type: 'text',
        content:
          'Stöver, Heino/Schuller, Klaus 1992. Praxis und Politik der Vergabe von sterilem Spritz-besteck an Drogenabhängige zur HIV/AIDS-Prävention in einer ausgewählten Zahl von Mitgliedsstaaten der europäischen Region der Weltgesundheitsorganisation (WHO). In: Deutsche AIDS-Hilfe (ed.), AIDS und Drogen II. Berlin: DAH.',
      },
    ],
    startDate: '1991',
    endDate: '',
    ...
    sources: [
      {
        type: 'text',
        content:
          'Nelles, Joachim/Harding, Timothy 1995. Preventing HIV transmission in prison: a tale of medical disobedience and Swiss pragmatism. The Lancet 346(8989):1507-1508.',
      },
      {
        type: 'text',
    ...
    sources: [
      {
        type: 'text',
        content:
          'Abgeordnetenhaus von Berlin, 12. Wahlperiode. Antrag der Fraktion Bündnis 90/Die Grünen /AL)/UFV, 4.3.1992. Drucksache 12/1224.',
      },
    ],
    startDate: '1992',
    endDate: '',
    ...
    sources: [
      {
        type: 'text',
        content:
          'Pant, Anand 2000. Die HIV-Epidemie unter I.v.-Drogenbenutzern: Verlauf, Primärprävention und drogenpolitische Reaktion. In: Marcus, Ulrich (ed.), Glück gehabt? Zwei Jahrzehnte AIDS in Deutschland. Berlin: Blackwell Wissenschaftsverlag, pp.184-210.',
      },
    ],
    startDate: '1992',
    endDate: '',
    ...
    sources: [
      {
        type: 'text',
        content:
          'Abgeordnetenhaus von Berlin, 12. Wahlperiode. Inhaltsprotokoll Rechtsausschuß 29. Sitzung, 24.9.1992.',
      },
      {
        type: 'text',
        content:
          'Abgeordnetenhaus von Berlin, 12.Wahlperiode. 38.Sitzung, 29.10.1992, Plenarprotokoll 12/38.',
      },
    ],
    startDate: '1992',
    endDate: '',
...

  {
    ...
    sources: [
      ...
      },
      {
        type: 'text',
        content:
          'Stöver, Heino/ Lines, Rick 2006. Silence still=death: 25 years of HIV/AIDS in prisons. In: Matic, Srdan et al. (eds.), HIV/AIDS in Europe. Moving from death sentence to chronic disease management. Copenhagen: WHO Regional Office for Europe, pp. 67-85.',
      },
      {
        type: 'text',
    ...
    sources: [
      {
        type: 'text',
        content:
          'Keine Spritzen für Gefangene. Frankfurter Rundschau, 17.1.1994, Frankfurt.',
      },
    ],
    startDate: '1994',
    endDate: '',
...

  {
    ...
    linksWith: [
      ...
      '1990_aids_enquetekommission',
      '1992_amendment_of_narcotics',
      '1994_ex_prisoner_sues',
      '1995_positive_evaluation_of',
    ],
    baseStory: baseStory,
  },
    ...
    sources: [
      {
        type: 'text',
        content:
          'Gaserow, Vera 1994. Starre Grundsätze. Musterprozeß eines Strafgefangenen um die Ausgabe von Spritzen in Gefängnissen. Die Zeit, 21.10.1994.',
      },
      {
        type: 'text',
        content:
          'Desselberger, Alex 1994. Mit höchstem Risiko. Focus Magazin, 26.9.1994.',
      },
    ],
    startDate: '1994',
    endDate: '',
    ...
    sources: [
      {
        type: 'text',
        content:
          'Ärztepräsident für sterile Spritzen im Gefängnis. Der Tagesspiegel, 25.11.1992. Berlin.',
      },
      {
        type: 'text',
        content:
          'Clearingstelle für Substitution/Christian Bauer (Chaim Jellinek) 1994. “Vorschlag zur Planung und Durchführung eines "HIV- und Hepatitis-Präventionsprojekts" in einer Berliner Haftanstalt. Unpublished.',
      },
      {
        type: 'text',
        content:
          'Christian Bauer (Chaim Jellinek) 1994. Besuch im all-schweizerischen Frauengefängnis Hindelbank, Treffen mit dem Direktor ad int., Herrn M. Lachat; 30.9.94, 10.00 Uhr bis 11.30 Uhr. Unpublished.',
      },
    ],
    startDate: '1994',
    endDate: '',
...

  {
    ...
    sources: [
      {
        type: 'text',
        content:
          'Nelles, Joachim et al. 1995. Pilotprojekt Drogen- und HIV-Prävention in den Anstalten in Hindelbank: Evaluationsbericht. Bern: Bundesamt fur Gesundheitswesen.',
      },
      {
        type: 'text',
    ...
    linksWith: [
      '1994_berlin_parliamentary_debate',
      '1994_medical_association_pro',
      '1995_scientific_study_shows',
      '6_jun_1996_berlin',
    ],
    baseStory: baseStory,
  },
    ...
    sources: [
      {
        type: 'text',
        content:
          'Senatsverwaltung für Justiz, 20.1.1995. Antwort auf die Kleine Anfrage Nr. 6269 vom 12.12.1994.',
      },
      {
        type: 'text',
        content:
          'Senatsverwaltung für Justiz, 26.1.1995. Antwort auf die Kleine Anfrage Nr. 6276 vom 16.12.1994.',
      },
      {
        type: 'text',
        content: 'Interview with Heino Stöver',
    ...
    sources: [
      {
        type: 'text',
        content:
          'Müller, R/Stark. K./Guggenmoos-Holzmann, I./Wirth, D./Bienzle, U.1995. Imprisonment: a risk factor for HIV infection counteracting education and prevention programmes for intravenous drug users. AIDS 9(2):183-190.',
      },
    ],
    startDate: '1995',
    endDate: '',
...

  {
    ...
    sources: [
      {
        type: 'text',
        content:
          'Stöver, Heino 2002. Drug and HIV/AIDS Services in European Prisons. Oldenburg: BIS-Verlag.',
      },
      {
        type: 'link',
        content:
          'https://www.aidshilfe.de/sites/default/files/documents/Band-42-1-Lebhaft-klein_online.pdf',
        url:
          'https://www.aidshilfe.de/sites/default/files/documents/Band-42-1-Lebhaft-klein_online.pdf',
      },
    ],
    ...
    linksWith: [
      '1989_jes_is_founded',
      '1990_1st_münchner_aids',
      '2001_hamburg_right_wing',
      '2003_lower_saxony_conservative',
    ],
    baseStory: baseStory,
  },
    ...
    sources: [
      {
        type: 'text',
        content:
          'Mitteilung der Senatsverwaltung für Justiz an das Abgeordnetenhaus von Berlin über Vergabe von Einwegspritzen an Gefangene zur AIDS-Prophylaxe, 8.2.1997.',
      },
    ],
    ...
    sources: [
      {
        type: 'text',
        content:
          'Stöver, Heino (n.d.). Jahre Spritzenvergabe an DrogenkonsumentInnen im Justizvollzug - das Ende für deutsche Projekte.',
      },
      {
        type: 'link',
        content: 'Published online for Akzept.org.',
        url:
          'https://www.akzept.org/pdf/menu_aktuel/10_jahre_spritzenvergabe.pdf',
      },
    ],
    startDate: '2001',
    endDate: '',
    ...
    sources: [
      {
        type: 'text',
        content:
          'Stöver, Heino 2009. Wie Infektionsgefahren  (HIV/AIDS, Hepatitis) im Strafvollzug ausgeblendet und wirksame Prophylaxe-Strategien nicht angewendet werden. In: Stöver, Heino/Pollähne, Helmut (eds.), Komplemente. In Sachen: Kriminologie, Drogenhilfe, Psychotherapie, Kriminalpolitik. Berlin: LIT.',
      },
      {
        type: 'text',
        content:
          'Meyenberg, Rüdiger et al. 1998. Infektionsprophylaxe im Niedersächsischen  Justizvollzug. Oldenburg: BIS-Verlag. ',
      },
    ],
    ...
    sources: [
      {
        type: 'text',
        content:
          'Interviews conducted and policy documents gatheres within the framework of EUROPACH project.',
      },
    ],
