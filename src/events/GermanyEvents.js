...
export const GermanyEvents = [
...

  {
    ...
    startDate: '1992',
    endDate: '',
    logics: [LOGICS.citizenship, LOGICS.deCriminalisation, LOGICS.evidence, LOGICS.publicHealth, LOGICS.security],
...

  {
    ...
    body: [
      ...
      {
        type: 'paragraph',
        content: `Heino Stöver, who conducted the scientific evaluation of the project, remembers how the Minister of Justice agreed to the project: "I remember that employees of the women's prison went to the Minister of Justice and handed the confiscated self-made syringes to her: 'These are the results of the confiscation. This is how the women make injection instruments by themselves. And this causes abscesses and leads to the transmission of viruses.' I think this was another point that finally convinced the Minister of Justice. It needs understanding, of course. But it also needs a personality and courage to take this decision."`
      },
      {
        type: 'paragraph',
