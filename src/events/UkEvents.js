...
export const UkEvents = [
...

  {
    ...
    body: [
      {
        type: 'paragraph',
        content: 'Legislation mandating certain powers where a notifiable disease (for the purposes of the legislation: cholera, plague, relapsing fever, smallpox, typhus) is suspected or confirmed, including: mandatory medical examination, removal to a hospital, detention in hospital.'
      },
    ],
    externalLinks: [],
    sources: [],
...

  {
    ...
    body: [
      {
        type: 'paragraph',
        content: 'Roy Cornes is accused of deliberately transmitting HIV to four women. There is extensive media coverage, but following R v Clarence, it is thought that no law applies.'
      },
    ],
    externalLinks: [],
    sources: [],
...

  {
    ...
    body: [
      {
        type: 'paragraph',
        content: '‘An Act to make it unlawful to discriminate against disabled persons in connection with employment, the provision of goods, facilities and services or the disposal or management of premises; to make provision about the employment of disabled persons; and to establish a National Disability Council’'
      },
      {
        type: 'paragraph',
        content: 'For the purposes of this Act, a person is considered to have a disability if, ‘he has a physical or mental impairment which has a substantial and long-term adverse effect on his ability to carry out normal day-to-day activities’. As such, the Act protects the rights of people living with HIV but only where they are symptomatic.'
      },
    ],
    externalLinks: [],
    sources: [],
...

  {
    ...
    body: [
      {
        type: 'paragraph',
        content: 'A 25 year-old woman is convicted of administering a noxious thing after injecting her male partner with HIV positive blood. She is sentenced to spend two years in prison before being deported.'
      },
    ],
    externalLinks: [],
    sources: [],
...

  {
    ...
    body: [
      {
        type: 'paragraph',
        content: 'At the 11th International Conference on AIDS in Vancouver, findings are presented which demonstrate the effectiveness of triple combination therapy in treating HIV.'
      },
    ],
    externalLinks: [],
    sources: [],
...

  {
    ...
    body: [
      {
        type: 'paragraph',
        content: '[SCOTLAND] Stephen Kelly is convicted of “culpable and reckless conduct” under Scots law. Kelly had contracted HIV in Glenochil Prison, Scotland in 1993, where he was one of at least 14 people serving a custodial sentence to become HIV positive.'
      },
    ],
    externalLinks: [],
    sources: [],
...

  {
    ...
    body: [
      ...
      {
        type: 'paragraph',
        content: 'Although there had been warnings – such as the Stephen Kelly conviction in Scotland a couple of years earlier – this case comes as a shock to the HIV sector. Positions and tactics on the matter are variable both within and between HIV organisations.'
      },
    ],
    externalLinks: [],
    sources: [],
  ...
  {
    name: 'Crown Prosecution Service agree to develop working group on prosecutorial guidelines',
    url: 'crown_prosecution_service_agree',
    body: [
      {
        type: 'paragraph',
        content: 'Crown Prosecution Service agree (in discussion with National AIDS Trust (NAT) and Terrence Higgins Trust (THT)) to create a working group on Prosecutorial Guidelines. This is a result, in part, of NAT employing existing equalities legislation to persuade them, on the grounds that black migrants are affected disproportionately.'
      },
    ],
    externalLinks: [],
    sources: [],
...

  {
    ...
    body: [
      {
        type: 'paragraph',
        content: 'Crown Prosecution Service (CPS) makes a draft of their Prosecutorial Guidance paper available for public consultation. The paper outlines draft prosecutorial policy on the sexual transmission of infections causing grievous bodily harm.'
      },
    ],
    externalLinks: [],
    sources: [],
...

  {
    ...
    body: [
      ...
      {
        type: 'paragraph',
        content: '‘The Government in 1998 cited the resulting stigma and discrimination against those living with HIV and relevant communities as the main reason not to prosecute for reckless HIV transmission. That argument still stands – and its prediction is unfortunately being fulfilled’ (pg 10).'
      },
    ],
    externalLinks: [],
    sources: [],
...

  {
    ...
    body: [
      {
        type: 'paragraph',
        content: 'A gay man is acquitted after defence team challenge phylogenetic analysis evidence. In previous HIV transmission cases in England and Wales, phylogenetic analysis evidence had been accepted by defendants, however, after expert testimony by Anna-Maria Geretti – brought in by the defence team – the judge directs the jury to acquit on the basis of the unreliability of the scientific evidence (cf. NAM, 2013; Weait, 2007) '
      },
...

  {
    ...
    body: [
      {
        type: 'paragraph',
        content: 'In Criminalization of HIV Transmission governments around the world are urged to limit the criminalisation of HIV transmission to those who know they are HIV positive, act with intention to transmit the virus and do transmit it.'
      },
...

  {
    ...
    body: [
      {
        type: 'paragraph',
        content: 'A review by Terrence Higgins Trust (THT) of the police handling of cases, including recommendations. The review is the result of a research project wherein a Community Advisory Panel (CAP), Metropolitan Police Service (MPS) and the Association of Chief Police Officers (ACPO) reviewed written digests of six cases and explored police practice in HIV transmission investigations. As stated in the document, this followed THT Direct, the THT Policy Team and other community organisations being contacted by police officers asking for guidance.'
      },
      {
        type: 'paragraph',
        content: 'The report focusses on five themes: disclosure, access to medical records, ‘how the case arose and who within the police handled it’, additional support or advice from outside the police force and media interaction. Good practice and opportunities for improvement are also identified.'
      },
      {
        type: 'paragraph',
        content: 'Although the report indicates that they found many instances of good practice, it also details issues where cases could have been handled more appropriately, for example, the report details a case where an unknown number of people known to the accused had been informed of the accused’s HIV status and that a media strategy had been considered in order to trace or alert other potential witnesses (this idea did not come to fruition, as it was deemed to be inappropriate).'
      },
      {
        type: 'paragraph',
        content: 'The report also states that – until Prosecutorial Guidance had been produced – the Offences Against the Person Act had often been misinterpreted, including by local Crown Prosecution Service (CPS) offices, which had led to a number of investigations where it was clear a crime had never occurred.'
      },
    ...
    endDate: '',
    logics: [LOGICS.collaborativeGovernance],
    linksWith: ['association_of_the_chief', 'violence_reforming_the_offences', 'prosecutorial_guidance_launched'],
    baseStory: baseStory,
  },

  {
    name: 'Prosecutions for HIV Transmission: A Guide for People Living with HIV in England and Wales',
  ...
  {
    name: 'Association of the Chief Police Officers (ACPO) Investigation Guidance',
  ...
  {
    name: 'BHIVA: HIV Transmission, the Law and the Work of the Clinical Team (position paper)',
    url: 'bhiva_hiv_transmission_the',
    body: [
      {
        type: 'paragraph',
        content: 'Opens by stating that the British HIV Association (BHIVA) and the British Association for Sexual Health and HIV (BASHH) support UNAIDS recommendations and the Oslo Declaration that a non-punitive approach be taken to HIV. The document offers recommendations for clinicians in the context of British criminal law. '
      },
      {
        type: 'paragraph',
...

  {
    ...
    endDate: '',
    logics: [LOGICS.deCriminalisation],
    linksWith: ['mohammed_dica', 'r_v_clarence', 'legislating_the_criminal_code', 'violence_reforming_the_offences'],
    baseStory: baseStory,
  },

  {
    ...
    body: [
      {
        type: 'paragraph',
        content: 'Rowe is convicted in November 2017 of five counts of causing grievous bodily harm and five counts of attempted grievous bodily harm. This is the first conviction in the UK of intentional transmission of HIV.'
      },
    ],
    externalLinks: [],
    sources: [],
  ...
  {
    name: '"New regulations on charging migrants will have a severe impact upon public health"',
...

  {
    ...
    body: [
      {
        type: 'paragraph',
        content: 'A number of police forces announce trials to use ‘spit hoods’ or ‘spit guards’ to stop officers being bitten or spat at. Spit hoods are mesh fabric bags which are placed over the heads of suspects. Links are publicly made between biting/spitting and HIV or hepatitis transmission.'
      },
    ],
    externalLinks: [],
    sources: [],
...

  {
    ...
    body: [
      {
        type: 'paragraph',
        content: 'Private Member’s Bill which would introduce a new offence for assaulting an emergency service worker and could lead to a person suspected of offences against an emergency service worker having to give bodily samples for testing (e.g. for HIV or Hepatitis).'
      },
      {
        type: 'paragraph',
