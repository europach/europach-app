...
export const PolandEvents = [
...

  {
    ...
    endDate: '',
    logics: [LOGICS.securitisation, LOGICS.deCriminalisation, LOGICS.humanitarianism, LOGICS.deCriminalisation],
...

  {
    ...
    endDate: '',
    logics: [LOGICS.humanitarianism, LOGICS.humanRights, LOGICS.deCriminalisation, LOGICS.deCriminalisation],
