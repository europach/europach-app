...
export const PolandEvents = [
    ...
    body: [
      {
        type: 'paragraph',
        content:
          'Poland ratified the UN Single Convention on Narcotic Drugs (1961) in 1966, but the state did not exert control over the cultivation of poppy, which in the 1970s was used for a domestic production of the ‘Polish heroin’. ',
      },
    ],
    externalLinks: [],
    sources: [
      ...
      },
      {
        type: 'text',
        content:
          'Drug policy profile: Poland, EMCDDA Papers, Publications Office of the European Union, Luxembourg.',
      },
    ],
    startDate: '1966',
    endDate: '',
    ...
    sources: [
      {
        type: 'text',
        content:
          'European Monitoring Centre for Drugs and Drug Addiction. (2014). Drug policy profile: Poland, EMCDDA Papers, Publications Office of the European Union, Luxembourg.',
      },
      {
        type: 'text',
        content:
          'Malinowska-Sempruch, K. (2013). HIV among Drug Users in Poland: The Paradoxes of an Epidemic, Columbia University.',
      },
    ],
    startDate: '1976',
    endDate: '',
...

  {
    ...
    body: [
      ...
      },
      {
        type: 'paragraph',
        content:
          'The drug-free treatment has been promoted throughout the years as the best solution for dealing with drug dependency problems and has received much higher support from public funds than substitute treatment. However, the specific methods of  therapy  (e.g. isolation in the treatment facility;  lack of official common standards for therapists) raised a question about a possibility of human rights violations, especially in the realm of a lack of the systemic evaluation of these actions (Maresz 2012).',
      },
    ],
    externalLinks: [],
    sources: [
      {
        type: 'text',
        content:
          'interviews conducted under the framework of EUROPACH project; Kotański, M. (1984). Ty zaraziłeś ich narkomanią. Warszawa: Państwowy Zakład Wydawnictw Lekarskich.',
      },
      {
        type: 'link',
        content:
          'Maresz, M. (2012). Przemoc w terapii, Accessed 2 February, 2019.',
        url: 'http://jump93.pl/portal/download/file_id/112/pid/30.html',
      },
    ],
    startDate: 'August 1981',
    endDate: '',
    logics: [LOGICS.humanitarianism, LOGICS.securitisation],
    linksWith: [
      'polish_chemistry_students_discovered',
      'first_syringe_exchange_programs',
      'monar_in_krakow_introduces',
    ],
    baseStory: baseStory,
  },
    ...
    sources: [
      {
        type: 'text',
        content:
          'Ustawa o zapobieganiu narkomanii z 31 stycznia 1985 roku (Dziennik Ustaw 1985 nr 4, poz. 15, art. 1',
      },
      {
        type: 'text',
        content:
    ...
    body: [
      {
        type: 'paragraph',
        content:
          'In response to the HIV epidemic MONAR decided to open shelters and treatment centers for people living with HIV in 1988. Additionally, MONAR organized charity events, concerts and protests expressing their solidarity with this group. Over the next few years MONAR activists, however, expressed a skeptical attitude toward harm reduction services. ',
      },
    ],
    externalLinks: [],
    sources: [],
    ...
    body: [
      {
        type: 'paragraph',
        content:
          'Poland ratified the 1988 UN Convention in 1994. The convention (especially Art. 3(2)) was used in a debate over criminalization of possession of drug use for personal use. The proponents of criminalization of drug use claimed that the convention required states to criminalize drug possession.',
      },
    ],
    externalLinks: [],
    sources: [
    ...
    sources: [
      {
        type: 'text',
        content:
          'Juszczyk, J. and Gładysz, A. (1993). AIDS: epidemiologia, patogeneza, klinika, leczenie, zapobieganie, poradnictwo. Wrocław: Volumed.',
      },
    ],
    startDate: '1988',
    endDate: '',
    ...
    body: [
      {
        type: 'paragraph',
        content:
          'The interviewees of the EUROPACH project stated that the first syringe and needle exchange programs were introduced in Poland clearly “out of fear” of HIV/AIDS among people who inject drugs. These programs were rather fragmented and isolated actions.',
      },
    ],
    externalLinks: [],
    sources: [],
...

  {
    ...
    sources: [
      {
        type: 'text',
        content:
          'Baran-Furga H., Chmielewska K. (1994). Terapia Metadonem,  Alkoholizm i Narkomania, 1(15), 25-45',
      },
      {
        type: 'text',
        content:
          'K, Steinbarth-Chmielewska, H. Baran-Furga. (1995). Pilotażowy program metadonowy. Zasady organizacyjne i cele. In: Program Metadonowy na tle innych programów rehabilitacyjnych osób uzależnionych w profilaktyce HIV/AIDS/ Konferencja Międzynarodowa. Jadwisin 12-14 września 1994. Warszawa: Biuro ds. Narkomanii, pp. 75-83',
      },
    ],
    ...
    linksWith: [
      'first_syringe_exchange_programs',
      'a_conference_program_metadonowy',
      'regulation_of_the_ministry',
    ],
    baseStory: baseStory,
  },
  ...
  {
    name:
      'A conference "Program metadonowy na tle innych programów rehabilitacyjnych osób uzależnionych w profilaktyce HIV/AIDS" (Methadone program in the context of other rehabilitation programs for addicts in HIV/AIDS prevention)',
...

  {
    ...
    sources: [
      {
        type: 'text',
        content:
          'Coffin, P. O. (2002). Marketing harm reduction: a historical narrative of the International Harm Reduction Development Program. International Journal of Drug Policy, 13, 213-224.',
      },
    ],
    startDate: '1995',
    endDate: '',
    ...
    linksWith: [
      'monar_in_krakow_introduces',
      'meeting_warsaw_to_found',
      'undp_projects_for_poland',
    ],
    baseStory: baseStory,
  },

  {
    ...
    linksWith: [
      'setting_up_monar',
      'first_syringe_exchange_programs',
      'international_harm_reduction_development',
    ],
    baseStory: baseStory,
  },
    ...
    sources: [
      {
        type: 'text',
        content:
          'CDuda, A. & Stroes, E.J. (2001). Terminal Evaluation Report UNDP Poland: AIDS and HIV Project. P0L1961003 Support to Civil Society Organisations, POL/97/003 Managing the Social and Public Health Consequences of HIV and AIDS. Warsaw.',
      },
    ],
    startDate: '1996',
    endDate: '2000',
...

  {
    ...
    sources: [
      {
        type: 'text',
        content:
          'Ustawa z dnia 24 kwietnia 1997 roku o przeciwdziałaniu narkomanii (Dziennik Ustaw 1997 nr 75, poz. 468)',
      },
      {
        type: 'text',
        content:
      ...
      },
      {
        type: 'text',
        content:
          'Stasiowski, J. (2009).  Geneza obecnej ustawy o przeciwdziałaniu narkomanii, IN Karanie za posiadanie. Artykuł 62 ustawy o przeciwdziałaniu narkomanii – koszty, czas, opinie, Kuźmicz, Mielecka-Kubień, Wiszejko-Wierzbicka (eds.), Warszawa: Instytut Spraw Publicznych,  pp.13-18',
      },
      {
        type: 'text',
        content:
          'Kuźmicz, E., Mielecka-Kubień, Z., Stasiowski, J. and Wiszejko-Wierzbicka, D. (2009).Penalizacja Posiadania Narkotyków - Działania Instytucjonalne I Koszty. Warszawa: Instytut Spraw Publicznych.',
      },
    ],
    ...
    linksWith: [
      'the_1985_drug_law',
      'the_1988_un_convention',
      'parliamentary_discussion_over_a',
      'the_2000_amendment_to',
      'the_2005_act_on',
    ],
    baseStory: baseStory,
  },
    ...
    body: [
      {
        type: 'paragraph',
        content:
          'In 1997 in Warsaw various organizations and activists from Central and Eastern Europe met in order to establish a harm reduction network in the region. This cooperation has been initiated by the involvement of UNDP and IHRD in Central and Eastern Europe. ',
      },
    ],
    externalLinks: [],
    sources: [],
...

  {
    ...
    endDate: '',
    logics: [
      LOGICS.securitisation,
      LOGICS.deCriminalisation,
      LOGICS.humanitarianism,
      LOGICS.deCriminalisation,
    ],
...

  {
    ...
    sources: [
      {
        type: 'text',
        content:
          'Prawa człowieka – osób zażywających narkotyki i osób zakażonych HIV. (2003) Konferencje i Seminaria 10(53)03,  Biuletyn Biura  Studiów i Ekspertyz Kancelarii Sejmu,  Warszawa: Kancelaria Sejmu.',
      },
      {
        type: 'text',
        content:
    ...
    linksWith: [
      'the_1997_drug_abuse',
      'parliamentary_discussion_over_a',
      'consequences_of_the_2000',
      'a_conference_on_people',
      'the_2005_act_on',
    ],
    baseStory: baseStory,
  },
    ...
    body: [
      {
        type: 'paragraph',
        content:
          'The 2000 law hampered needle and syringe programs by undermining their legality. Introducing an amendment by the Bureau for Drug Addiction in 2001 stating that one of the state policy goals was harm reduction, “re-legalized” the programs (Ibid.). In 2002 twenty one needle & syringe exchange programs were available in Poland.',
      },
    ],
    externalLinks: [],
    sources: [
    ...
    sources: [
      {
        type: 'text',
        content:
          'Ustawa z dnia 29 lipca 2005 r. o przeciwdziałaniu narkomanii (Dz.U. 2005 nr 179 poz. 1485) European Monitoring Centre for Drugs and Drug Addiction. (2014). Drug policy profile: Poland, EMCDDA Papers, Publications Office of the European Union, Luxembourg.',
      },
    ],
    ...
    sources: [
      {
        type: 'link',
        content:
          'A story of criminalization of methadone has been described e.g. in the following article, [access: 4.07.2018]',
        url:
          'https://www.polityka.pl/tygodnikpolityka/spoleczenstwo/286523,1,metadon-zakazany-w-trojmiescie.read',
      },
      {
        type: 'link',
        content: 'More information available, [access: 4.07.2018]',
        url:
          'http://gdansk.naszemiasto.pl/artykul/relacja-ze-spotkania-metadon-w-gdansku,3002618,art,t,id,tm.html [access: 4.07.2018]',
      },
      {
        type: 'link',
        content: 'More information available, [access: 4.07.2018]',
        url:
          'http://wyborcza.pl/duzyformat/1,127290,9394026,Cud_metadonowy.html',
      },
    ],
    startDate: '2007',
    endDate: '2009',
    ...
    body: [
      {
        type: 'paragraph',
        content:
          'The Polish Network of Drug Policy was set up in 2008 as a civil informal initiative and formalized as a foundation in 2014. The main aim of the network is to initiate and support a debate over drug policies and to promote more progressive approach toward psychoactive substances.',
      },
    ],
    externalLinks: [],
    sources: [],
...

  {
    ...
    sources: [
      {
        type: 'text',
        content:
          'Krajewski, K. (2008), Sprawy o posiadanie narkotyków w praktyce sadów krakowskich, raport z badań, Jagiellonian University, Kraków',
      },
      {
        type: 'text',
        content:
    ...
    startDate: '2008',
    endDate: '2009',
    logics: [LOGICS.deCriminalisation, LOGICS.humanRights],
    linksWith: [
      'the_2000_amendment_to',
      'the_2005_act_on',
      'consequences_of_the_2000',
...

  {
    ...
    body: [
      ...
      },
      {
        type: 'paragraph',
        content:
          '(f) Ensure the enactment and implementation of a comprehensive antidiscrimination and equality law to help ensure the full enjoyment of the right to health, based on equality and non-discrimination within the State."',
      },
    ],
    externalLinks: [],
    sources: [
      {
        ...
        url:
          'https://documents-dds-ny.un.org/doc/UNDOC/GEN/G10/134/03/PDF/G1013403.pdf?OpenElement',
      },
      {
        type: 'link',
        content: 'Accessed 2 February, 2019.',
    ...
    endDate: '05/11/2009',
    logics: [LOGICS.humanRights, LOGICS.deCriminalisation],
    ...
    body: [
      {
        type: 'paragraph',
        content:
          'In response to voices demanding access to substitution treatment in the Pomeranian region, different organizations: Klub Krytyki Politycznej w Gdańsku (Gdańsk Club of the Political Critique), Open Society Institute, Polska Sieć ds. Polityki Narkotykowej (Polish Network of Drug Policy), Stowarzyszenie Jump 93 (Jump 93 Association) organized a debate on a right to substitution treatment, access to health and human rights of people who use drugs. They invited harm reduction activists, medical doctors, and people who use drugs.',
      },
    ],
    externalLinks: [],
    sources: [
      {
        ...
        url:
          'http://krytykapolityczna.pl/narkopolityka/polskienarko/metadon-w-gdansku-relacja/',
      },
    ],
    ...
    body: [
      {
        type: 'paragraph',
        content:
          'In 2008 shops and websites legally selling ‘dopalacze’ (New Psychoactive Substances) emerged in the large Polish cities (a number of shops in 2010 came to 1000). Dopalacze were marketed primarily as legal ‘party drugs’. The media debate around NPS focused on a risk of poisonings, especially among young people.',
      },
    ],
    externalLinks: [],
    sources: [],
...

  {
    ...
    sources: [
      {
        type: 'text',
        content:
          'The amended Act of 20 March 2009 on counteracting drug addiction [Dz.U. ‘Journal of Laws’ of 2009 No. 63 item 520]',
      },
      {
        type: 'text',
        content:
          'The amended Act of 10 June 2010 on counteracting drug addiction [Dz.U. ‘Journal of Laws’ of 2010 No. 143 item 962]',
      },
    ],
    ...
    linksWith: [
      'the_2005_act_on',
      'the_polish_government_announces',
      'npss_dopalacze_treated_as',
    ],
    baseStory: baseStory,
  },

  {
    ...
    body: [
      {
        type: 'paragraph',
        content:
          'Due to the article 62 on drug possession was slightly changed (prosecutors could suspend criminal charges when the amount of drugs for personal was small). However, Polish drug law remained as strict as it was before despite this amendment.',
      },
    ],
    externalLinks: [],
    sources: [],
    ...
    endDate: '',
    logics: [LOGICS.deCriminalisation, LOGICS.deCriminalisation],
    linksWith: [
      'studies_showing_social_consequences',
      'the_special_rapporteur_on',
    ],
    baseStory: baseStory,
  },
    ...
    body: [
      {
        type: 'paragraph',
        content:
          'The former president of Poland – Aleksander Kwaśniewski – expressed regret over his past endorsement of the 2000 law and published an article in New York Times.',
      },
    ],
    externalLinks: [],
    sources: [
    ...
    body: [
      {
        type: 'paragraph',
        content:
          'The National Health Program introduces harm reduction as one of its priorities and an official instrument of the state policy.',
      },
    ],
    externalLinks: [],
    sources: [
      {
        type: 'link',
        content:
          'Source: Rozporządzenie Rady Ministrów z dnia 4 sierpnia 2016 w sprawie Narodowego Programu Zdrowia na lata 2016-2016, Accessed 2 February, 2019.',
        url:
          'http://prawo.sejm.gov.pl/isap.nsf/download.xsp/WDU20160001492/O/D20161492.pdf',
      },
    ],
    startDate: '2016',
    endDate: '2020',
    ...
    body: [
      {
        type: 'paragraph',
        content:
          'As a result of the 2nd International Conference "Urban Drug Policy 2016" in Warsaw, Warsaw Declaration - a document with recommendations for European cities regarding urban  drug policies - has been prepared. The document was based on a critical evaluation of the Prague Declaration and stated that a drug-free world was unrealistic as a concept. It promoted developing and implementing evidence-informed drug policies, programs and harm reduction services at the local level.',
      },
    ],
    externalLinks: [],
    sources: [],
    ...
    body: [
      {
        type: 'paragraph',
        content:
          'Polish right wing government introduced the new amendment to the anti-drug law, in which new substances are covered by the criminal law. According to the new regulation, the list of the controlled substances will be issued by the regulation of the Minister of Health, which means that criminalizing ‘legal highs’ faster than it was before.',
      },
    ],
    externalLinks: [],
    sources: [],
